    ...
    return (
        <section id="treatment-options">
            ...
            <div className="row" style = {{marginRight : '10%', marginLeft : '10%', marginBottom : '5%'}}>
                ...
                <div className="col-6" >
                    <img style = {{width : '80%'}} src="./treatmentOption.jpg" alt="......" />
                </div>
            </div>
            <div style = {{marginRight : '10%', marginLeft : '10%'}}>
                <div className="row" style = {{marginBottom : '10px'}}>
                    ...
                    <div className="col-8"><strong>Chemotherapy:</strong><br />
                ...
                <div className="row" style = {{marginBottom : '10px'}}>
                    ...
                    <div className="col-8"><strong>Hormone Therapy:</strong><br />
                ...
                <div className="row" style = {{marginBottom : '10px'}}>
                    ...
                    <div className="col-8"><strong>Hyperthermia</strong><br />
                ...
                <div className="row" style = {{marginBottom : '10px'}}>
                    ...
                    <div className="col-8"><strong>Immunotherapy</strong><br />
                ...
                <div className="row" style = {{marginBottom : '10px'}}>
                    ...
                    <div className="col-8"><strong>Radiation Therapy</strong><br />
                ...
                <div className="row" style = {{marginBottom : '10px'}}>
                    ...
                    <div className="col-8"><strong>Stem Cell Transplant</strong><br />
                ...
                <div className="row" style = {{marginBottom : '10px'}}>
                    ...
                    <div className="col-8"><strong>Surgery : </strong><br></br>
